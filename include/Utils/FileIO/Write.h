...
namespace FileIO {
    ...
    inline void WriteFile(std::string fileName, std::string data, WriteType wt = WriteType::Append){
    ...
    template <typename T>
    inline void WriteFile_Binary(const std::string& filename, const T& data, WriteType mode) {
